        ...
        <div className="w-full lg:w-1/2 flex flex-col pt-8 lg:sticky lg:top-32 h-fit">
          ...
          <div className="flex flex-col gap-8 w-full max-w-md">
            ...
            <div className="flex flex-col gap-4">
              ...
              {/* WhatsApp Helper */}
              <a href="https://wa.me/919056550173" target="_blank" rel="noopener noreferrer" className="mt-2 text-xs font-body uppercase tracking-widest flex items-center gap-2 opacity-70 hover:opacity-100 transition-opacity w-fit">
